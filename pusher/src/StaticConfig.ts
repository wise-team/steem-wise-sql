...
export class StaticConfig {
    ...
    public static TIMEOUT_MS: number = /*§ d(data.config.sql.pusher.blockProcessingTimeoutMs) §*/9000/*§§.*/;
    public static BUFFERED_BLOCK_LOADER_CONCURRENCY_PER_NODE: number = /*§ d(data.config.sql.pusher.requestConcurrencyPerNode) §*/3/*§§.*/;
}