...
export const data = {
  ...
  "get_block": true,
    ...
    "docker": {
      ...
      "labels": {
        "domain": "vote.wise",
        "defaultLabels": [ () => "maintainer=\"The Wise Team (https://wise-team.io/) <jedrzejblew@gmail.com>\"", () => "vote.wise.wise-version=\"2.1.0\"", () => "vote.wise.license=\"MIT\"", () => "vote.wise.repository=\"steem-wise-sql\"" ],
      },
